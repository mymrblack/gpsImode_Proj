...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = myImode
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myImode_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = myip_fifo_ctrl
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = myip_fifo_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = newGpsIp
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = newGpsIp_0
END
